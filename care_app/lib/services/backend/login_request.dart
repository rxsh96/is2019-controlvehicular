...
Future<LoginModel> requestLoginAPI(
  ...
  if (response.statusCode >= 200 && response.statusCode <= 202 ) {
    ...
    preferences.setString('email', body['email']);
    Navigator.of(context).pushReplacementNamed('/vehiclePage');
