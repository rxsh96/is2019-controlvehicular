...
class API {
  ...
  Future<User> getUser({@required String email}) async {
    final MyResponse response = await _apiHelper.get<User>(
        endPoint: ApiRoutes.USERS, queryParam: '?email=$email');
    if (response.isSuccess) {
      final List<dynamic> jsonUser =
          _decoder.convert(response.result.toString());
  ...
  Future<List<Vehicle>> getUserVehicles({@required int owner}) async {
    final MyResponse response = await _apiHelper.get<Vehicle>(
        endPoint: ApiRoutes.VEHICLES, queryParam: '?owner=$owner');
    if (response.isSuccess) {
  ...
  Future<ProfileImageModel> getProfilePicURL({@required int id}) async {
    final MyResponse response = await _apiHelper.get<ProfileImageModel>(
        endPoint: ApiRoutes.UPLOAD_PROFILE_IMG, queryParam: '?user=$id');
    if (response.isSuccess) {
      final List<dynamic> jsonUser =
          _decoder.convert(response.result.toString());
      if (jsonUser.isNotEmpty) {
  ...
  Future<List<MaintenanceModel>> getMaintenanceGuide(
      {@required int vehicleModel}) async {
    final MyResponse response = await _apiHelper.get<MaintenanceModel>(
        endPoint: ApiRoutes.MAINTENANCE,
  ...
  Future<List<ItemModel>> getMaintenanceItem() async {
    final MyResponse response = await _apiHelper.get<MaintenanceModel>(
        endPoint: ApiRoutes.MAINTENANCE_ITEMS);
    if (response.isSuccess) {
  ...
  Future<List<MaintenanceDetailsModel>> getMaintenanceDetails(
      {@required int vehicleID}) async {
    final MyResponse response = await _apiHelper.get<MaintenanceModel>(
        endPoint: ApiRoutes.MAINTENANCE_DETAILS,
        queryParam: '?vehicle=$vehicleID');
    if (response.isSuccess) {
  ...
  Future<Map<String, dynamic>> postUser(
    ...
    final MyResponse response =
        await _apiHelper.post<User>(endPoint: ApiRoutes.USERS, data: user);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<Map<String, dynamic>> postMaintenance(
      {@required Map<String, dynamic> maintenance}) async {
    final MyResponse response = await _apiHelper.post<MaintenanceModel>(
        endPoint: ApiRoutes.MAINTENANCE_DETAILS, data: maintenance);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<Map<String, dynamic>> postAccident(
    ...
    final MyResponse response =
        await _apiHelper.post<User>(endPoint: ApiRoutes.ACCIDENTS, data: data);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<Map<String, dynamic>> postPasswordReset(
      {Map<String, String> data}) async {
    final MyResponse response =
        await _apiHelper.post<dynamic>(endPoint: ApiRoutes.RESET, data: data);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<Map<String, dynamic>> postProfilePic(
      {@required Map<String, dynamic> image}) async {
    final MyResponse response = await _apiHelper.post<ProfileImageModel>(
        endPoint: ApiRoutes.UPLOAD_PROFILE_IMG, data: image);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<Map<String, dynamic>> postVehicle(
      {@required Map<String, dynamic> vehicle}) async {
    final MyResponse response = await _apiHelper.post<Map<String, dynamic>>(
        endPoint: ApiRoutes.VEHICLES, data: vehicle);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<List<TransitTaxModel>> getTransitTax({@required int userID}) async {
    final MyResponse response = await _apiHelper.get(
        endPoint: ApiRoutes.TRANSIT_TAX, queryParam: '?user=$userID');
    if (response.isSuccess) {
  ...
  Future<Map<String, dynamic>> postTransitTax(
      {@required Map<String, dynamic> tax}) async {
    final MyResponse response = await _apiHelper.post<Map<String, dynamic>>(
        endPoint: ApiRoutes.TRANSIT_TAX, data: tax);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<Map<String, dynamic>> postFCMDevice(
      {@required DeviceModel deviceInformation}) async {
    final Map<String, dynamic> data = deviceInformation.toJson();
    final MyResponse response = await _apiHelper.post<DeviceModel>(
        endPoint: ApiRoutes.DEVICE, data: data);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<Map<String, dynamic>> putFCMDevice(
      {@required DeviceModel deviceInformation,
      String registrationToken}) async {
    final Map<String, dynamic> data = deviceInformation.toJson();
    final MyResponse response = await _apiHelper.patch<DeviceModel>(
        endPoint: ApiRoutes.DEVICE, instance: registrationToken, data: data);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<Map<String, dynamic>> putKm(
      {@required String vehicleID, Map<String, dynamic> data}) async {
    final MyResponse response = await _apiHelper.patch(
        endPoint: ApiRoutes.VEHICLES, instance: vehicleID, data: data);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
  ...
  Future<List<ModelModel>> getVehicleModels() async {
    final MyResponse response =
        await _apiHelper.get<ModelModel>(endPoint: ApiRoutes.MODELS);
    if (response.isSuccess) {
  ...
  Future<List<BrandModel>> getVehicleBrands() async {
    final MyResponse response =
        await _apiHelper.get<ModelModel>(endPoint: ApiRoutes.BRANDS);
    if (response.isSuccess) {
  ...
  Future<List<BusinessModel>> getBusiness() async {
    final MyResponse response =
        await _apiHelper.get<BusinessModel>(endPoint: ApiRoutes.BUSINESS);
    if (response.isSuccess) {
  ...
  Future<Map<String, dynamic>> postComments({Map<String, String> data}) async {
    final MyResponse response = await _apiHelper.post<dynamic>(
        endPoint: ApiRoutes.SUGGESTIONS, data: data);
    if (response.isSuccess) {
      return _decoder.convert(response.result);
    }
    return <String, dynamic>{'error': 'error'};
...
List<ModelModel> parseModels(String responseBody) {
  final dynamic parsed = json.decode(responseBody).cast<Map<String, dynamic>>();
  return parsed
      .map<ModelModel>((dynamic json) => ModelModel.fromJson(json))
      .toList();
}
...
List<BrandModel> parseBrands(String responseBody) {
  final dynamic parsed = json.decode(responseBody).cast<Map<String, dynamic>>();
  return parsed
      .map<BrandModel>((dynamic json) => BrandModel.fromJson(json))
      .toList();
}
...
List<BusinessModel> parseBusiness(String responseBody) {
  final dynamic parsed = json.decode(responseBody).cast<Map<String, dynamic>>();
  return parsed
      .map<BusinessModel>((dynamic json) => BusinessModel.fromJson(json))
      .toList();
}
...
List<ItemModel> parseMaintenanceItem(String responseBody) {
  final dynamic parsed = json.decode(responseBody).cast<Map<String, dynamic>>();
  return parsed
      .map<ItemModel>((dynamic json) => ItemModel.fromJson(json))
      .toList();
}
...
List<MaintenanceDetailsModel> parseMaintenanceDetails(String responseBody) {
  final dynamic parsed = json.decode(responseBody).cast<Map<String, dynamic>>();
  return parsed
      .map<MaintenanceDetailsModel>(
          (dynamic json) => MaintenanceDetailsModel.fromJson(json))
      .toList();
}

List<TransitTaxModel> parseTax(String responseBody) {
  final dynamic parsed = json.decode(responseBody).cast<Map<String, dynamic>>();
  return parsed
