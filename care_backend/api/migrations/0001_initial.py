# Generated by Django 2.2 on 2020-01-09 16:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_business_owner', models.BooleanField(blank=True, default=False, verbose_name='Dueño de Negocio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Fecha de edición')),
                ('lon', models.DecimalField(decimal_places=16, max_digits=22, null=True)),
                ('lat', models.DecimalField(decimal_places=16, max_digits=22, null=True)),
                ('business_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Brand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.Maintenance_item')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='', max_length=255)),
                ('brand', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Brand')),
                ('m_name', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Maintenance_item')),
                ('model', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Model')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Affiliate_business_Clients',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now=True, null=True, verbose_name='Fecha de edición')),
                ('business', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Affiliate_business')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliate_business', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.Affiliate_business')),
            ],
        ),
    ]
